...
const catalogJs = fs.readFileSync(path.join(root, 'js', 'catalog.js'), 'utf8');
...
[
  ...
  ['js/main.js', mainJs, 'NMAGANDA Satıcısı'],
  ...
  ['js/catalog.js', catalogJs, 'V8 OBSESSION HOODIE'],
  ['js/catalog.js', catalogJs, 'DRIFT KING OVERSIZE T-SHIRT'],
  ['js/catalog.js', catalogJs, 'CAFE RACER VINTAGE T-SHIRT'],
  ['js/catalog.js', catalogJs, 'APEX CHASER LONG SLEEVE'],
  ['js/catalog.js', catalogJs, 'BURN RUBBER CAP'],
  ['js/catalog.js', catalogJs, 'BUILT FOR THE OBSESSED HOODIE'],
  ['js/catalog.js', catalogJs, 'REDLINE TRACKSUIT'],
  ['js/catalog.js', catalogJs, 'window.MAGANDA_PRODUCT_CATALOG = ['],
  ['js/main.js', mainJs, 'MAGANDA_PRODUCT_CATALOG || []'],
  ['js/catalog.js', catalogJs, 'APEX Predator Hoodie'],
  ['js/catalog.js', catalogJs, 'SPEED HUNTER BEANIE'],
  ['js/catalog.js', catalogJs, 'CBR 600RR Baskılı Regular Fit Motorcu Tişörtü'],
  ['js/catalog.js', catalogJs, 'S1000RR Baskılı Regular Fit Motorcu Tişörtü'],
  ['js/catalog.js', catalogJs, '"colors": {'],
  ['js/catalog.js', catalogJs, '"krem-bej": ['],
  ['js/catalog.js', catalogJs, 'assets/img/V8 OBSESSION HOODIE/beyaz/ChatGPT Image 11 May 2026 14_03_56.png'],
  ['js/catalog.js', catalogJs, 'assets/img/DRIFT KING OVERSİZE T-SHIRT/siyah/modelarka.png'],
  ['js/main.js', mainJs, 'initProductColorOptions'],
  ['js/main.js', mainJs, 'getProductColorGalleries'],
  ['js/catalog.js', catalogJs, 'ChatGPT Image 11 May 2026 13_48_20.png'],
